...
class User_ft extends EE_Fieldtype
{
	...
	public function replace_tag				(){ return $this->__call(__FUNCTION__, func_get_args()); }
	public function pre_process				(){ return $this->__call(__FUNCTION__, func_get_args()); }
	public function validate				(){ return $this->__call(__FUNCTION__, func_get_args()); }
	public function display_publish_field	(){ return $this->__call(__FUNCTION__, func_get_args()); }
	public function save					(){ return $this->__call(__FUNCTION__, func_get_args()); }
	public function post_save				(){ return $this->__call(__FUNCTION__, func_get_args()); }
	public function delete					(){ return $this->__call(__FUNCTION__, func_get_args()); }
	//required argument by the parent abstract
	public function display_field			($data){ return $this->__call(__FUNCTION__, func_get_args()); }
