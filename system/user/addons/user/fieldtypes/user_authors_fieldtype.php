...
/**
 * User - Related Authors Fieldtype
 *
 ...
 * @filesource	user/fieldtypes/user_authors_fieldtype.php
 */
...
class User_authors_fieldtype extends EE_Fieldtype
{
	...
	public function display_field($data)
	{
		...
		if (! empty($data['data']) AND AJAX_REQUEST)
		{
			...
			if (! empty(ee()->input->get_post('search_related')))
			{
				$rel->filter('screen_name', 'LIKE', '%' . ee()->input->get_post('search_related') . '%');
			}
